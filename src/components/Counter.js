...
export default function Counter() {
  ...
  useEffect(() => {
    ...
    let clockInterval = setInterval(() => {
      ...
      const end = +new Date(`Jul 05, ${year} 12:00:00`).getTime();
  ...
  if(clockData.dd+clockData.hh+clockData.mm+clockData.ss<0){
    return (
      <div>
        <span className="l2-txt1 p-b-9 days">time expired!</span>
      </div>
    )
  }
  return (
